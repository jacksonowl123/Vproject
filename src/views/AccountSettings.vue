<template>
  <div class="p-4">
    ...
    <div v-if="!authState.memberDetails" class="py-20 flex justify-center">
    ...
    <div v-else class="space-y-6">
      ...
      <div v-if="activeTab === 'profile'" class="bg-white p-6 rounded-lg shadow-md">
        <h3 class="text-lg font-semibold mb-4">Edit Profile Information</h3>
...
export default defineComponent({
  ...
  setup() {
    ...
    // Call populateProfileForm on mount
    onMounted(() => {
      populateProfileForm();
    });
